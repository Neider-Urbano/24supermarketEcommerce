...
public class ProductosPaginacion {
    private List<ProductosDto> contenido;
    ...
    public List<ProductosDto> getContenido() {
        return contenido;
    }

    public void setContenido(List<ProductosDto> contenido) {
